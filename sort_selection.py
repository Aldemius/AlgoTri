...
# Sort selection with search of the min (itérative version)
...
# Sort selection with search of the min (recursive version)
...
# Sort selection with search of the min + display as a graph
